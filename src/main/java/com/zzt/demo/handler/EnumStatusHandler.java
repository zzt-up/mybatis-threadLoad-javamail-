...
import com.zzt.demo.model.enums.EnumStatus;
...
/**
 *@Project demo
 *@PackageName com.zzt.demo.handler
 *@ClassName EnumStatusHandler
 *@Author zzt
 *@Date 2020/10/20 16:06
 *@Description 自定义EnumStatus转换类   存储属性：EnumStatus.getCode()  JDBCType：INT ,继承了这个枚举的都可以使用,实体类也得实现序列化接口
 */
public class EnumStatusHandler<E extends Enum<?> & EnumStatus> extends BaseTypeHandler<EnumStatus> {
